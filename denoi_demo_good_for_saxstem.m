...
tic; im_d = denoi_BLS_GSM(im0, sig, PS, blSize, parent, boundary, Nsc, Nor, covariance, optim, repres1, repres2, seed); toc
...
outputPath = fullfile(folder, [filename , 'Portilla', 'Sigma', num2str(sig), '.tiff'])
...
t.setTag('ImageLength',size(im_d,1));
t.setTag('ImageWidth',size(im_d,2));
